...
# 前言
此教程在熱心的客戶幫助下，一直在迭代更新，目前您看到的是第八版（2022.2.12）。
...
![輸入圖片說明](Pictures/IMG_8102.JPG)

這時可以重啟機器，重啟後再次回到套件處：
1.如果還是顯示「已啟用」，但是您還沒有購買網卡則可以去選購下單了。
2.如果還是顯示「已啟用」，且你已經有網卡，但是沒有識別，嘗試「停用」再「啟用」，如果通過這個操作網卡出現了，那麼請往下看。
...
## 2.仍有問題？
那麼屬於疑難雜症了，請參閱：
[https://fu.chiphello.com/2021/06/a-knotty-problem-2.5g/](https://fu.chiphello.com/2021/06/a-knotty-problem-2.5g/)
