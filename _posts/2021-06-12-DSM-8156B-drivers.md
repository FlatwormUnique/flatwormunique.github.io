...
# 前言
此教程在热心的客户帮助下，一直在迭代更新，目前您看到的是第七版（2022.1.31）。

我强烈建议您看完教程，一来这是很多玩家智慧的结晶；二来我一直认为折腾硬件和谈恋爱是一个道理，其中的过程是最美妙，成功驾驭后，获得的满足感是无可替代的。

教程的篇幅看起来比较长，但是请不要胆怯，我只是在玩家们的帮助下将50个字延展到了这么长，为的是让每一个过来的玩家都能看懂并且可操作，所以事无巨细稍显啰嗦，在您之前，已经有1300+人（2021.12.20）成功让群晖安装了2.5G网卡（数据源自店内销售统计，因为教程是开放的，实际人数应该大于这个数字），仔细的对照操作，成功是确定性事件。
...
列表里面有很多驱动，该下载哪一个呢？可以[右键点我新标签页打开群晖官网查询](https://kb.synology.com/en-global/DSM/tutorial/What_kind_of_CPU_does_my_NAS_have)
...
#### 1. 登录到群晖的WEB界面，打开套件中心，手动安装我们之前下载的spk驱动文件。

注意，驱动安装会出错，如下图：
（感谢@joshua_zhu_99提供图片素材）
...
如果出现了这个画面，请选择“E”，这样就进入了编辑模式。**注意，上图画面不一定会出现，如果没有出现，请直接进入下面的流程，不用按“E”进入编辑模式。**
...
## 4.仍有问题？
那么属于疑难杂症了，请参阅：[https://fu.chiphello.com/2021/06/a-knotty-problem-2.5g/](https://fu.chiphello.com/2021/06/a-knotty-problem-2.5g/)
