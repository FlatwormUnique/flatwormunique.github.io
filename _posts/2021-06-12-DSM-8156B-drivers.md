...
---
# 比前言更重要的话
视频教程：<iframe src="//player.bilibili.com/player.html?aid=590697469&bvid=BV1pq4y1o7x1&cid=414749124&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
...
# 前言
此教程在热心的客户帮助下，一直在迭代更新，目前您看到的是第六版（2021.12.20）。
...
```
#### 2. 登录到群晖的WEB界面，打开套件中心，手动安装我们之前下载的spk驱动文件。

注意，如果不执行上述命令，驱动安装会出错，如下图。
